...
\maketitle
\begin{abstract}
The treatment of the semantics of adjectives is notorously challenging, also in the context of the so called ontology-lexicon interface which attempts to capture the semantics of words by reference to an ontology in description logics or some other, typically first-order, logical formalism.
...
ontology. In particular, beyond the straightforward intersective adjectives, there exist i) \emph{gradable adjectives} requiring fuzzy or
