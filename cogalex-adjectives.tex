...
split the world's population into `tall' and `not tall'. \textcolor{blue}{This kind of dilemma is know as the \textit{sorites} paradox or \textit{sorites} vagueness (\cite{Bennett06kr}:36), for which many terms and adjectives in natural language are vague given the 
existence of a specific threshold to relate them to other properties or observables.}} In fact, while it may 
...
\textbf{\textcolor{red}{better explain this part}}
