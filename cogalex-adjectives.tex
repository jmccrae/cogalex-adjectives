...
task is driven by the fact that the application of this model to answering facts 
...
A related syntactic phenomena for Polish is explored by \cite{partee2003there}.
...
meaning of \emph{ursus maritimus}.
...
`Belgian' can be achieved as follows (depicted in figure \ref{example-belgian}).
...
Gradable adjectives are naturally defined relative to a particular property
\footnote{Note in many cases the property is quite abstract such as in 
...
5'5'' (165cm) and as such a male of 6' would have been considered clearly to be 
...
head of such a construction! \textbf{hmm...} This understanding is unambiguous 
assuming there is no attributive frame for the adjective as well. In this case 
