...
adjectives are subsective, for example `a big mouse' is not `a big animal'.\textit{In case you need a citation for this statement: Morzycki p. 23 ex. (55) (56): "the biggest classes of subsective adjectives are gradable"}} An 
...
\begin{quote}
\textbf{Juan is a researcher.\textit{this point is tricky. Looks like you are mixing copula with attribute. Since later you just develop Belgian in LEMON, I'd leave this example out}}
...
`breakable' \textbf{moar}}, that is it is natural to say that \textbf{`big' refers to 
