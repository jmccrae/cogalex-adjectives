...
property {\tt height}\textcolor{green}{Is this correct?}. With lemonOILS we can add this information as follows:
...
it is possible to understand that `high' objects exceed the default minimum.

The primary weakness of this approach is captured by the following example:
...
for the class of basketball players he is unusually short. As such we must introduce default values for
every possible subclass of person. This potentially leads to an explosion in the amount of information we
