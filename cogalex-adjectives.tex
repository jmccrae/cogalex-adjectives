...
\usepackage{enumitem}
\usepackage{color}
>>>>>>> f6601524d664b0fc8f7bf513e4e73e3d03dcaf15
...
Ref.\url{http://www.ucl.ac.uk/internet-grammar/adjectiv/attribut.html}}}
\textbf{\textcolor{blue}{This is what it already says right?}}
...
\begin{description}
\item[Intersective] ($X\mathrm{~is~a~}A~N \Rightarrow X\mathrm{~is~}A \\text{\ and\ } X\mathrm{~is~a~}N$) 
